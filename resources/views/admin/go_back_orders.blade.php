...
@section('content')
    <title>إدارة رحلات لعودة المتظرة</title>
    <div class="container-xl">
        <div class="card shadow-lg bg-white py-4 px-4" style="border-radius: 40px">
            ...
            <h3 class="text-primary text-center">إدارة رحلات لعودة المتظرة</h3>
            <br>
            ...
            <table class="table table-bordered table-secondary table-responsive-lg">
                ...
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td>
                            @if($order->return_option == 0)
                                غير محدد
                            @elseif($order->return_option == 1)
                                خدمة الإنتظار حتي العودة
                            @elseif($order->return_option == 2)
                                الإتصال عند الإنتهاء
                            @else
                                {{ $order->return_date_time ?? "غير محدد" }}
                            @endif
                        </td>
