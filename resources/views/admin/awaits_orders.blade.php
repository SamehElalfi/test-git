                            ...
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <select class="form-control" name="sort">
                                        ...
                                        <option value="cost$$$DESC" {{ ($sort == 'created_at$$$DESC') ? "selected":"" }}>المبلغ الأقل - الأكبر</option>
                                        <option value="cost$$$ASC" {{ ($sort == 'created_at$$$ASC') ? "selected":"" }}>المبلغ الأكثر - الأقل</option>
