            ...
            <div align="center">
                ...
                <form method="post" action="{{ route('admin.panel.car.update', $car->id) }}">
                    ...
                    <div id="name" class="row my-3">
                        ...
                        <div class="col-9">
                            <input type="text" placeholder="إسم السيارة..." name="name" value="{{ $car->name ?? "" }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div id="phone" class="row my-3">
                        ...
                        <div class="col-9">
                            <input type="text" placeholder="نوع السيارة..." name="type" value="{{ $car->type ?? "" }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div id="phone" class="row my-3">
                        ...
                        <div class="col-9">
                            <input type="number" placeholder="عدد الركاب..." name="count" value="{{ $car->passengers ?? "" }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div id="phone" class="row my-3">
                        ...
                        <div class="col-9">
                            <input type="text" placeholder="رقم السيارة..." name="number" value="{{ $car->number ?? "" }}" class="form-control">
                        </div>
                    </div>
