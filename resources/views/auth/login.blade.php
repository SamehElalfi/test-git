                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">البريد الإلكتروني او رقم الهاتف</label>

                                <div class="col-md-6">
                                    <input id="email" type="email" placeholder="الإيميل او رقم الهاتف" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
